...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
   ...
   updateSku() {
         if (this.dataset.layout == 'main-product') { 
  ...
  updateMedia() {
    ...
    } else if (this.dataset.layout == 'shoe-two-column-layput') {      
      var index = this.currentVariant.featured_media.position;
      $('.product-thumb-slider a').classList.add('slick-active');
  ...
  update_notify(){
    if(this.currentVariant.available != true){
       $('.notify-sold').show();
      $('.template-product').find('.prorow-lbl-qntty').hide();
      $('.template-product').find('.product-form__buttons').hide();
      }else{
       $('.notify-sold').hide();
       $('.template-product').find('.prorow-lbl-qntty').show();
       $('.template-product').find('.product-form__buttons').show();
    }
  ...
  updateVariantInputss() {
        if (this.dataset.layout == 'main-product') {
      const product = this.closest('.main-product');
